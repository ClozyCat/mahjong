    ...
    render(
      <EvaluationDialog
        ...
        users={[
          ...
          createDialogUser(5, '在线玩家 B', 'online'),
          createDialogUser(6, '对局玩家 B', 'playing'),
        ]}
        selectedUserIds={[]}
