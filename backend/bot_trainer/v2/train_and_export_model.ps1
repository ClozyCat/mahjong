...
try {
    ...
    Write-Host "Architecture: Lightweight actor + suit-fusion tile CNN + GRU discard sequence + opponent modeling"
    Write-Host "Loss weights: value=$ValueLossWeight fan=$FanLossWeight qfan=$QualifyingFanLossWeight opponent=$RiskLossWeight"
