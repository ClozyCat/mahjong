...
pub enum GameEvent {
    ...
    TileDrawn { seat: Seat, tile: Tile, source: String },
    TileDiscarded { seat: Seat, tile: Tile },
    MeldClaimed { seat: Seat, meld: Vec<String>, from: Seat },
    HuDeclared { winner: Seat, source: String },
