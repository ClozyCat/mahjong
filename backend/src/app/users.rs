...
mod tests {
    ...
    fn user_title_thresholds_are_lower_inclusive_upper_exclusive() {
        assert_eq!(title_for_points(-1_000), "LV1.散财童子");
        assert_eq!(title_for_points(-50), "LV1.散财童子");
        assert_eq!(title_for_points(49), "LV1.散财童子");
        assert_eq!(title_for_points(50), "LV2.点炮能手");
        assert_eq!(title_for_points(149), "LV2.点炮能手");
        assert_eq!(title_for_points(150), "LV3.慈善赌王");
        assert_eq!(title_for_points(549), "LV6.迷途麻客");
        assert_eq!(title_for_points(550), "LV7.入门雀友");
        assert_eq!(title_for_points(649), "LV7.入门雀友");
        assert_eq!(title_for_points(650), "LV8.初露锋芒");
        assert_eq!(title_for_points(1_349), "LV14.封神雀圣");
        assert_eq!(title_for_points(1_350), "LV15.至尊雀神");
        assert_eq!(title_for_points(9_999), "LV15.至尊雀神");
    }

    #[test]
    fn user_title_display_label_appends_title_with_parentheses() {
        assert_eq!(display_label("Alice", 550), "Alice（LV7.入门雀友）");
    }
